...
type
  ...
  TDeadlyObstaclesList = TObjectList<TDeadlyObstacle>;
...
procedure TDeadlyObstacle.HitPlayer(const ATransform: TCastleTransform);
var
  LPlayer: TPlayer;
begin
  ...
  if LPlayer.IsPlayerDead then begin
    IsPlayerColliding := false;
    CollidingTime := 0;
  end;
end;
